...
export const AdminAPI = {
  ...
  async decideReport(entity: EntityType, reportId: UUID, result: "suspend" | "reject", adminId: UUID) {
    const response = await api.post(`/admin/reports/${entity}/${reportId}/decide`, {
      result,
      reviewer_id: adminId,
    });
